...
public class TestAuto extends OpMode {
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 1:
                if(!follower.isBusy()){
                    follower.setStartingPose(scorePose);  // ★ FIX
            ...
            case 2:
                if(!follower.isBusy()){
                    follower.setStartingPose(pickup1Pose);  // ★ FIX
            ...
            case 4:
                if(!follower.isBusy()){
                    follower.setStartingPose(pickup2Pose);  // ★ FIX
            ...
            case 6:
                if(!follower.isBusy()){
                    follower.setStartingPose(pickup3Pose);  // ★ FIX
            ...
            case 7:
                if(!follower.isBusy()){
                    follower.setStartingPose(scorePose);  // ★ FIX (optional)
                    setPathState(-1);
                }
                break;
        }
